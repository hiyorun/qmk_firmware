...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT(
        ...
        KC_LCTL,    KC_LALT,       KC_LGUI,       KC_INT5,                  KC_SPC,    KC_SPC,                     KC_INT4,       KC_INT2,       KC_RALT,       MO(1),      KC_RCTL,    KC_LEFT,    KC_DOWN,    KC_RGHT
    ),
    [1] = LAYOUT(
        ...
        KC_TRNS,    KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,   KC_TRNS,   KC_TRNS,     KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,       KC_TRNS,                KC_VOLD,    KC_MUTE,    KC_VOLU,
        KC_TRNS,    KC_TRNS,       KC_TRNS,       KC_TRNS,                  KC_TRNS,   KC_MPLY,                    KC_TRNS,       KC_TRNS,       KC_APP,        KC_TRNS,    KC_TRNS,    KC_MPRV,    KC_MPLY,    KC_MNXT
    )
};

//KC_MPLY, KC_TRNS, KC_MPRV, KC_VOLD, KC_MNXT, KC_APP, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, 